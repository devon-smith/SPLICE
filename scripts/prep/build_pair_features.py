# build the 2305-d pair feature for every cut (concat + abs-diff + cos)
# --mode boundary uses one keyframe per side; --mode mean_pool_3 averages 3
# --include_hadamard appends the elementwise product -> 3073-d
# usage: python scripts/prep/build_pair_features.py --mode boundary
