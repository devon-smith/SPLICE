...
# CS231N Lec 8: Vision Transformer (ViT-B/14) backbone — DINOv2
# CS231N Lec 12: DINOv2 pretrained via self-supervised distillation
class DINOv2Encoder:
    def __init__(self, model_id="facebook/dinov2-base", device=None,
        ...
        self.model = AutoModel.from_pretrained(model_id).to(self.device).eval()  # CS231N Lec 6: Transfer learning: loading pretrained DINOv2 weights
    ...
    def encode(self, pixel_values):
        ...
        with torch.autocast(device_type="cuda" if on_gpu else "cpu",  # CS231N Lec 11: fp16 mixed precision training
